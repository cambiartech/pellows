...
import { Pool } from "pg";
import { hashPassword } from "../src/lib/agency-auth";
...
async function main() {
  ...
  // Owner block on Coral House peak week
  ...
  console.log(
    `Seeded ${created.length} listings for Detty December + global (host ${host.email})`,
  );
}
